...
export class ExtendedDMMFFieldRelationMap extends ExtendedDMMFFieldOmitField {
  ...
  constructor(
    ...
    // TODO instead of setting a zod type, get the relationmap entry for the field
    // TODO add a method that can be called to check if it should be picked, and the pick attributes
